...
# build a debug version of skirt in the "debug" directory
...
$CMAKEPATH -E chdir ../debug $CMAKEPATH -DCMAKE_EXPORT_COMPILE_COMMANDS=1 -DCMAKE_BUILD_TYPE:STRING=Debug -GNinja -L ../git
echo
